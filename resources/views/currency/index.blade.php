            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" id="currency_exchange_rate" name="exchange_rate" class="form-control" step="0.01" required>
                    </div>
                </div>
        ...
        editButtons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                if (id) {
                    ...
                    currencyForm.insertAdjacentHTML('beforeend', '<input type="hidden" name="_method" value="PUT">');
                } else {
